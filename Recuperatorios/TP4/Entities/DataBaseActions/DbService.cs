...
namespace Entities.DataBaseActions
{
    public static class DbService
    {
        ...
        /// </summary>
        /// <returns></returns>
        /// <returns> Retorna el dato pedido, o null en caso de error.</returns>
        ...
        /// <returns> Retorna el movimiento pedido, o null en caso de error.</returns>
        ...
        /// Si un movimiento de la wallet local, no existe en la BD, lo añade.
        /// </summary>
        ...
        /// </summary>
        /// <returns> El mayor ID encontrado, o -1 en caso de error </returns>
