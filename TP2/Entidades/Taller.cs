...
namespace Entidades
{
    ...
    public class Taller
    {
        ...
        {
            if(taller.vehiculos != null && taller.vehiculos.Contains(vehiculo) == false 
                && taller.espacioDisponible > 0)
            {
        ...
        public static Taller operator -(Taller taller, Vehiculo vehiculo)
        {
            if(taller.vehiculos != null && taller.vehiculos.Contains(vehiculo) == true)
            {
